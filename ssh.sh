...
cat /etc/ssh_config_bkp | sed 's/#PermitRootLogin yes/#PermitRootLogin '$permitroot'/'  | sed 's/#Protocol 2/Protocol '$protocol'/' | sed 's/#Port 22/Port '$port'/' > /etc/ssh/ssh_config
